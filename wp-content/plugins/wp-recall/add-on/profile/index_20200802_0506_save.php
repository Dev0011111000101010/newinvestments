...
function rcl_tab_profile() {
	...
	rcl_tab(
		array(
			'id'		 => 'profile',
			'name'		 => __( 'Личные данные', 'wp-recall' ),
			'supports'	 => array( 'ajax' ),
			'public'	 => 0,
			'icon'		 => 'fa-user',
			'content'	 => array(
...
//	);
	...
	$profileFields[] = array(
		'slug'		 => 'number',
		'title'		 => __( 'Ваш телефон', 'wp-recall' ),
		'type'		 => 'tel',
		'required'	 => 0,
	);
	$profileFields[] = array(
		'slug'		 => 'social_facebook',
		'title'		 => __( 'Facebook', 'wp-recall' ),
		'type'		 => 'text',
		'required'	 => 0,
	);
	$profileFields[] = array(
		'slug'		 => 'social_linkedin',
		'title'		 => __( 'LinkedIn', 'wp-recall' ),
		'type'		 => 'text',
		'required'	 => 0,
	);
	$profileFields[] = array(
		'slug'		 => 'social_instagram',
		'title'		 => __( 'Instagram', 'wp-recall' ),
		'type'		 => 'text',
		'required'	 => 0,
	);
	$profileFields[] = array(
		'slug'		 => 'social_telegram',
		'title'		 => __( 'Telegram', 'wp-recall' ),
		'type'		 => 'text',
		'required'	 => 0,
	);
...
function rcl_tab_profile_content( $master_id ) {
	...
	$Table = new Rcl_Table( array(
		...
		'zebra'	 => true,
		//'border' => array('table', 'r$profileFieldsows')
		) );
